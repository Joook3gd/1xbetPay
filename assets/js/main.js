...
for(let y = 0; y < elementPay.length; y++){
    elementPay[y].onclick = _ => {
        if(textPay[y].innerText ==  "Vodafone"){
            imgBox.setAttribute("src", "https://github.com/Joook3gd/1xbetPay/blob/main/assets/images/vodafone.png");
            ...
            imgBox.setAttribute("src", "https://github.com/Joook3gd/1xbetPay/blob/main/assets/images/etisalat.svg");
            ...
            imgBox.setAttribute("src", "https://github.com/Joook3gd/1xbetPay/blob/main/assets/images/orange.png");
            ...
            imgBox.setAttribute("src", "https://github.com/Joook3gd/1xbetPay/blob/main/assets/images/wepay.png");
            ...
            imgBox.setAttribute("src", "https://github.com/Joook3gd/1xbetPay/blob/main/assets/images/cash/smart_wallet.png");
